...
| Frozen trace-integrity mutation evaluation | Canonical cross-layer trace schema + 3 clean traces + 15 deterministic corruptions + fixed detector/gates, frozen before aggregate detection | Deterministic local mutation protocol; unexecuted at freeze |
